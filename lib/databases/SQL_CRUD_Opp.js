...
module.exports.create = async (entity, payload) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const process00 = await entity.create({ ...payload });
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const process00 = await entity.findOne({
        attributes: {
          exclude: ["softDelete", "createdAt", "updatedAt"]
        },
        where: { ...condition, softDelete: 0 }
      });
  ...
  return new Promise(async (resolve, reject) => {
    ...
    try {
      ...
      const process00 = await entity.findAll({
        ...
        where: { ...paramBuild, ...req.body.filter, softDelete: 0 }
      });
  ...
  return new Promise(async (resolve, reject) => {
    ...
    if (req.$limit) {
      try {
        ...
        // Cast to number
        limit = Number.parseInt(req.$limit);
        page = Number.parseInt(req.$page);
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const process00 = await entity.update(
        { softDelete: 1, updatedAt: timestamp },
        { where: condition }
      );
